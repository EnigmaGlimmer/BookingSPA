    ...
    return <section>
            ...
            <div className='intro-form'>
                ...
                <div className='intro-content'>
                    ...
                    <div className='intro-content-form'>
                        ...
                        <div>
                            <button className='my-btn'>About Us</button>
                        </div>
                    </div>
            ...
            <div className='quality-form'>
                ...
                <div className='quality-item-form'>
                    <div className='quality-item'>
                        ...
                        <div className='quality-item-price'>
                            2.05 $
                        </div>
                        <div className='quality-item-name'>
                            Nails Services
                        </div>
                ...
                <div className='other-content'>
                    <div className='other-content-form'>
                        <div className='other-title'>
                            We also provide some other services such as…
                        </div>
                        <ul>
                            <li>Lash lift</li>
            ...
            <div className='booking-form'>
                ...
                <div className='booking-calendar'>
                    <div className='booking-calendar-title'>
                        Choose the right date for your service use
                    </div>
        ...
        <div className='gallery'>
            <div className='gallery-form'>
                ...
                <div className='gallery-view-more'>View More 
