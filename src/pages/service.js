    ...
    return <div>
        ...
        <div className='service-name'>
            <div className='service-name-form'>
                <div className='service-name-title'>
                    Service Name
                </div>
                <p className='service-name-content'>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut 
                    labore et dolore magna aliqua. Eget magna done fermentum iaculis eu non diam phasellus vestibulum. 
                    Id donec ultrices tincidunt arcu. Malesuada proin libero nunc consequat interdum varius sit amet. 
                    Eu ultrices vitae auctor eu augue ut lectus. Suscipit tellus mauris a diam. 
                    Viverra orci sagittis eu volutpat odio facilisis etmagnis dis parturient mananis 
                    interdum arcu ac tortor dignissim convallis aenean.
                </p>
                ...
                <div className='service-name-img-form'>
                    <img src={serviceContent} width={"100%"}/>
                    <p className='service-name-img-alt'>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, 
                    </p>
                </div>
                <p className='service-name-content'>
