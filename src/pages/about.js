    ...
    <section>
            ...
            <div className='about-story-form'>
                ...
                <div className='about-story-item-2'>
                    ...
                    <div className='about-story-content'>
                        Successful brands know that storytelling is a powerful marketing tool. They know how to use stories to get their
                        message across. But first, why brand stories? What famous brand stories are there? Because stories are the best
                        weapon we have for eliminating noise Because it organizes information in an attractive way Because it is the most 
                        effective tool to influence the human brain Or simply put: Brand story in marketing is a filter that helps 
                        to simplify the message. And thanks to it, people will see us, hear us and understand us.
                    </div>
        ...
        <div className='about-image-store'>
            <div className='about-image-store-form'>
                <div className='about-image-store-content'>
                    <div className='about-image-store-title'>
                        Little Daisy Stores
                    </div>
        ...
        <div className='about-deco'>
            <div className='about-deco-form'>
                ...
                <h1 className='about-deco-title'>
                    spiscing elit & sed do eiusmod
                </h1>
            </div>
        </div>
        {/* Staff */}
            ...
            <div className='about-staff-form'>
                ...
                <div className='about-staff-list'>
                    <div className='about-staff-item'>
                        ...
                        <div className='about-staff-item-name'>
                            Full Name
                        </div>
        ...
        <div className='about-booking'>
            ...
            <div className='about-booking-content'>
                <div className='about-booking-title'>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit 
                </div>
